...
$(function () {
    $("#slider-range").slider({
        ...
        slide: function (event, ui) {
            console.log(ui);
            $("#amount").val(10000000 - ui.values[1] + 10000);
            $("#amount_1").val(Math.abs(ui.values[0] - 10000000 - 10000));
        }
    });
    ...
    $("input#amount").change(function () {
        ...
        $("#slider-range").slider("values", 1, 10000000 - value1 + 10000)
    });
    //   For second input
    $("input#amount_1").change(function () {
        ...
        $("#slider-range").slider("values", 0, Math.abs(value2 - 10000000 - 10000))
    });
    // Filter to input
...
$(function () {
    $("#slider-range1").slider({
        ...
        values: [10000, 10000000],
        slide: function (event, ui) {
            $("#amount1").val(10000000 - ui.values[1] + 10000);
            $("#amount_2").val(Math.abs(ui.values[0] - 10000000 - 10000));
        }
    });
    ...
    $("input#amount1").change(function () {
        ...
        $("#slider-range1").slider("values", 1, 10000000 - value1 + 10000)
    });
    ...
    $("input#amount_2").change(function () {
        ...
        $("#slider-range1").slider("values", 0, Math.abs(value2 - 10000000 - 10000))
    });
    // Filter to input
...
$(function () {
    $("#slider-range2").slider({
        ...
        values: [10000, 10000000],
        slide: function (event, ui) {
            $("#amount2").val(10000000 - ui.values[1] + 10000);
            $("#amount_3").val(Math.abs(ui.values[0] - 10000000 - 10000));
        }
    });
    ...
    $("input#amount2").change(function () {
        ...
        $("#slider-range2").slider("values", 1, 10000000 - value1 + 10000)
    });
    //   For second input
    $("input#amount_3").change(function () {
        ...
        $("#slider-range2").slider("values", 0, Math.abs(value2 - 10000000 - 10000))
    });
