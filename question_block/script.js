...
DropDown.prototype = {
    initEvents: function () {
        ...
        obj.opts.on('click', function (ev) {
            ...
            obj.index = opt.index();
            if (obj.valueElement) {
                const val = opt.context.getElementsByClassName("phoneMenuItem")[0].getElementsByClassName("number")[0].innerText;
...
$(function () {
    ...
    let wrapper = new DropDown($('.convenient-send > .wrapper'));

    $(document).click(function () {
        $('.convenient-send > .wrapper').removeClass('active');
    });
});
